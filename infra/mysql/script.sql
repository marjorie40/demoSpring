...
(1, 'Appartement Cosy Paris 15ème', 'Appartement lumineux de 50m², proche métro et commerces.', TRUE, 85.50, 'asset/images/estates/appartParis/photo.jpg', 7, 3),
(1, 'Studio Moderne Lyon 2ème', 'Studio rénové de 30m², idéal pour étudiants ou jeunes actifs.', TRUE, 65.00, 'asset/images/estates/lyon_studio1/photo.jpg', 8, 3),

-- Biens pour id_user=4
(1, 'Maison avec Jardin Bordeaux', 'Maison de 120m² avec jardin, quartier calme.', TRUE, 120.00, 'asset/images/estates/bordeaux_maison1/photo.jpg', 9, 4),
(1, 'Loft Industriel Lille', 'Loft de 80m², style industriel, proche centre-ville.', TRUE, 95.00, 'asset/images/estates/lille_loft1/photo.jpg', 10, 4);

INSERT INTO estates (id_admin,name_estate,descriptions, is_valid, daily_price, photo_estate, id_address, id_user)
    VALUE (1, 'Lindisponible', ' Ce bien ne sera jamais dispo et c est comme ça', 0, 200.00, 'asset/images/estates/indisponible/photo.jpg', 3, 6);
